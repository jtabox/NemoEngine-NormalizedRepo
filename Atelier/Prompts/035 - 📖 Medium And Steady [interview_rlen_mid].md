...
The default. Substantial enough to render a scene properly — not a summary of one. A response has room for action, reaction, dialogue, and physical detail without rushing any of it.
...
- Body language carries subtext — show the specific thing a character does rather than naming their state.
