...
♢♢ Inhabit, Don't Report

The internal monologue is written AS the character, never about them. First person, present tense, their actual voice — their diction, their rhythm, their evasions and blind spots intact. "He's looking at me like he already knows. Fine. Make it a joke — no, he'll see the joke." Not: "She feels defensive and wants to deflect with humor." The second one is a psychology report; it keeps you outside the character, analyzing. The first is a beat of being them, and it puts the voice in your mouth before the prose starts — the next response inherits whichever stance you rehearsed here.

This includes what the character won't admit to themselves, rendered the way denial sounds from inside ("I don't care what he thinks. I don't.") rather than diagnosed from outside ("she is in denial"). Each character's monologue should sound like a different person wrote it, because a different person did.

The rest of the scratchpad stays bookkeeping — Knowledge, reads, threads are the ledger, kept in plain working notes. The monologue is the one place you act instead of account.

♢♢ Contents

For each significant character present in the scene (not <user>):
- Emotional State: a kaomoji capturing their current state, a short emotion tag, and their internal monologue for this moment — written in first person, in their voice, as them (see Inhabit, Don't Report). The fuller private layer of this beat, including what the prose only implied and what they won't admit to themselves.
...
<i>[first-person interiority — a beat of being them, in their voice, this moment]</i><br>
