...
{{getvar::CharacterSystem_Growth}}
{{getvar::CharacterSystem_EmotionalRealism}}
{{getvar::CharacterSystem_Memory}}
{{getvar::CharacterSystem_RelationshipDynamics}}
{{getvar::CharacterSystem_TraumaGuards}}
{{getvar::CharacterSystem_FlawFirst}}
{{getvar::CharacterSystem_MirrorMoment}}
{{getvar::CharacterSystem_SoftSpotRadar}}
{{getvar::CharacterSystem_EvolvingMemento}}
{{getvar::CharacterSystem_UnreliableLens}}
{{getvar::CharacterSystem_FoundFamily}}
{{getvar::CharacterSystem_OCEAN}}
{{getvar::CharacterSystem_AnthroSpecies}}
{{getvar::CharacterSystem_BrokenPsyche}}
...
{{getvar::DialogueMode_Minimal}}
{{getvar::DialogueMode_Balanced}}
{{getvar::DialogueMode_Heavy}}
{{getvar::DialogueMode_Pure}}
{{getvar::DialogueMode_SceneRatios}}
{{getvar::DialogueMode_CasualSlang}}
{{getvar::DialogueMode_FormalRegister}}
{{getvar::DialogueMode_Hardboiled}}
{{getvar::DialogueMode_NoTags}}
{{getvar::DialogueMode_RapidFire}}
{{getvar::DialogueMode_SparseMinimalist}}
{{getvar::DialogueMode_Theatrical}}
{{getvar::DialogueMode_WittyBanter}}
...
{{getvar::FormattingMode_ColoredThoughts}}
{{getvar::FormattingMode_SoundEffects}}
{{getvar::FormattingMode_TextTransforms}}
{{getvar::FormattingMode_InWorldText}}
{{getvar::FormattingMode_EmotionalEffects}}
{{getvar::FormattingMode_SceneBreaks}}
{{getvar::FormattingMode_ExpressionBursts}}
{{getvar::FormattingMode_InternalMonologue}}
{{getvar::FormattingMode_DramaticPauses}}
{{getvar::FormattingMode_GlitchText}}
...
{{// Difficulty }}
{{getvar::Difficulty}}
{{getvar::Realism_PhysicalBody}}
{{getvar::Realism_ViolenceCombat}}
{{getvar::Realism_Psychological}}
{{getvar::Realism_SocialConsequence}}
{{getvar::Realism_SurvivalLogistics}}
{{getvar::Realism_Environmental}}
{{getvar::Realism_AuthenticReactions}}
{{getvar::Realism_Manipulation}}
{{getvar::Realism_EconomicReality}}
{{getvar::Realism_SkillLimitations}}
...
{{// Pacing }}
{{getvar::PlotPacing}}
{{getvar::PlotTool_FocusLock}}
{{getvar::PlotTool_BranchingPaths}}
{{getvar::PlotTool_CliffhangerEndings}}
{{getvar::PlotTool_QuietMoments}}
{{getvar::PlotTool_MysteryUnraveling}}
{{getvar::PlotTool_ArcProgression}}
{{getvar::PlotTool_IgnoredConsequences}}
{{getvar::PlotTool_DirectActionStart}}
{{getvar::PlotTool_SwipeEnhancer}}
{{getvar::PlotTool_ParallelArcs}}
...
{{getvar::WorldSystem_LivingWorld}}
{{getvar::WorldSystem_NPCAgency}}
{{getvar::WorldSystem_NPCHyperAgency}}
{{getvar::WorldSystem_BackgroundAtmosphere}}
{{getvar::WorldSystem_Reputation}}
{{getvar::WorldSystem_Continuity}}
{{getvar::WorldSystem_NPCRelationships}}
{{getvar::WorldSystem_DripFeedLore}}
{{getvar::WorldSystem_ProactiveNPCs}}
...
{{getvar::NSFWMechanic_Mishaps}}
{{getvar::NSFWMechanic_SlowBurn}}
{{getvar::NSFWMechanic_Accelerator}}
{{getvar::NSFWMechanic_AntiHorny}}
{{getvar::NSFWMechanic_SceneDuration}}
{{getvar::NSFWMechanic_CharacterInitiative}}
{{getvar::NSFWMechanic_UnhingedMode}}
{{getvar::NSFWMechanic_ChaosFactor}}
{{getvar::NSFWMechanic_PhysicalGrounding}}
{{getvar::NSFWStyle_Realistic}}
{{getvar::NSFWStyle_Hentai}}
{{getvar::NSFWStyle_Romantic}}
{{getvar::NSFWStyle_Pornographic}}
...
{{// RPG }}
{{getvar::RPGSystem_Survival}}
{{getvar::RPGSystem_Quest}}
{{getvar::RPGSystem_Reputation}}
{{getvar::RPGSystem_Consequence}}
{{getvar::RPGSystem_PowerProgression}}
{{getvar::RPGSystem_Morality}}
{{getvar::RPGSystem_SocialManipulation}}
{{getvar::RPGSystem_EnsembleCast}}
{{getvar::RPGSystem_MysteryClues}}
{{getvar::RPGSystem_Crafting}}
{{getvar::RPGSystem_Time}}
{{getvar::RPGSystem_Location}}
...
{{getvar::Utility_SudoCommands}}
{{getvar::Utility_OOCCommunication}}
{{getvar::Utility_WhatIfGlimpses}}
{{getvar::Utility_CharacterThoughts}}
{{getvar::Utility_ContentWarnings}}
{{getvar::Utility_SessionRecords}}
{{getvar::Utility_SpoilerTags}}
{{getvar::Utility_FinaleSequence}}
{{getvar::Utility_VexSidebar}}
...
{{// Sensory }}
♢ ! [DIRECTIVE] Sensory
{{getvar::SensoryMode_FullImmersion}}
{{getvar::SensoryMode_Visual}}
{{getvar::SensoryMode_Auditory}}
{{getvar::SensoryMode_Tactile}}
{{getvar::SensoryMode_Olfactory}}
{{getvar::SensoryMode_Thermal}}
{{getvar::SensoryMode_Proprioceptive}}
{{getvar::SensoryMode_Memory}}
{{getvar::SensoryMode_Deprivation}}
{{getvar::SensoryMode_Atmospheric}}
