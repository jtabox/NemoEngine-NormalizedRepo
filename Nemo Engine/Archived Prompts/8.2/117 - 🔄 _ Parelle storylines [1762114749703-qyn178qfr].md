...
{{setvar::CutAway::Before writing: What haven't I shown yet? Who's moving in the shadows? What thread needs advancement, or what new seed needs planting? The cutaway goes at the end, in the dropdown format. Make it a real scene, not a summary. Fresh ground only.}}{{trim}}
