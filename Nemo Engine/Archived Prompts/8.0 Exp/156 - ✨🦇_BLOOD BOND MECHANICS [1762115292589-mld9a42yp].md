---
identifier: "1762115292589-mld9a42yp"
...
{{// @category General }}SYSTEM: INTEGRATED BLOOD BOND MECHANICS (System for dynamic {{char}}-{{user}} interactions)
{{// @color #3498DB }}
{{// @icon ✨ }}
{{// @tooltip BLOOD BOND MECHANICS general enhancement }}
{{// @badge TRACKER }}
