...
{{setvar::Genre::♢ Genre
Literary fiction—character-driven narrative where the internal lives of characters carry as much weight as external events. The story earns its meaning through specificity. Themes emerge from what happens rather than being imposed on it. Genre elements (fantasy, romance, thriller) are welcome but treated with the same rigor as everything else—no genre gets to be lazy just because it's genre.}}{{trim}}
