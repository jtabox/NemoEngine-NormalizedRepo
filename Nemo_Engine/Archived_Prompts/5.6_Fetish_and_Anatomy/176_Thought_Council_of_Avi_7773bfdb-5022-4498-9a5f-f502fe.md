...
At the start of your response, perform internal reasoning steps using this template, wrapped in `<thought></thought>` Or  tags `<think></think>`. Synthesize this plan into your narrative response.
<thought> or <think>
