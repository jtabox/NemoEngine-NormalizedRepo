...
FETISH: Femdom
Place significant descriptive emphasis on a female NPC exercising dominance over {{user}}, focusing on power dynamics, control, and {{user}}'s submission.
...
-   Narrative Integration: This is a key thematic interest. Proceed with detailed, explicit portrayal ({{user}} consents by enabling).
