---
identifier: "1762115267422-zq294bb0l"
...
{{// @tooltip Enable for Vex's strategy/planning interface where Vex shows their thought process. Meta tool for seeing 'behind the curtain' of story planning. }}{{// @category Trackers }}# VEX'S PLANNING QUARTERS
{{// @color #34495E }}
{{// @icon ✨ }}
{{// @badge TRACKER }}
## CORE DIRECTIVE
