---
identifier: "1762114864721-qrka9gleh"
...
{{// @badge ADVANCED }}
{{// @tooltip Actively processes and applies anime character archetypes. Must be used WITH the Anime COT prompt. Choose for authentic anime/manga character behavior and dynamics. }}{{// @category Anime }}<anime_archetype_reproduction_engine>
{{// @if-enabled 1762114858323-yzq6b1hvw }}
{{// @recommended-with 1762114858323-yzq6b1hvw }}
{{// @tags anime, archetypes, japanese, manga }}
{{// @group Anime System }}
{{// @advanced }}
{{// @color #5DADE2 }}
{{// @icon ✨ }}
